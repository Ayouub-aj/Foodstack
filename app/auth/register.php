        ...
        <div class="col-md-6 col-lg-5">
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-body p-4 p-lg-5">
                    <h2 class="fw-bold mb-4 text-center text-dark">Join RECIPE<span class="text-success">VAULT</span></h2>
                    ...
                    <form action="register.php" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" name="username" id="username" class="form-control" required placeholder="e.g. masterchef">
                        </div>
                        <div class="mb-3">
